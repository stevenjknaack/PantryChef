...
function NavBar() {
    ...
    function showNav(e) {
        ...
        if (loggedIn === null && !navBar.classList.contains('centered')) {
                    ...
                    {(loggedIn === null) && (
                        ...
                        {/* Brand name of the navbar which redirects to homepage when clicked */}
                            <div className='main-title-container'>
                                <Navbar.Brand as={Link} to="/" className="main-title" onClick={showNav}> PANTRY CHEF </Navbar.Brand>
                            </div>
                            <Container>
                    ...
                    {(loggedIn !== null) && (
                        <Navbar bg="primary" data-bs-theme="dark" fixed="top" className="navbar-custom" >
                            ...
                            <div className='main-title-container flex'>
                                ...
                                <button onClick={handleButtonClick} className='nav-btn'><svg width="100" height="59" viewBox="0 0 100 59" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs>
                                            <filter id="filter0_i_6_51" x="0" y="0" width="100" height="63" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                            ...
                            <Container>
                                <Nav className="nav-links column">
                                    ...
                                    <Nav.Link as={Link} to="/your-recipes" className='nav-link' onClick={handleButtonClick}><p>Your Recipes</p></Nav.Link>
                                    <Nav.Link as={Link} to="/logout" className='nav-link' onClick={handleButtonClick}><p>Logout</p></Nav.Link>
                                </Nav>
                            </Container>
                        </Navbar>
                    )}
